...
class InterfaceTest < Minitest::Test
  ...
  def test_known
    ...
    VCR.use_cassette("reflection.getMethds") do
  ...
  def test_list
    VCR.use_cassette("photos.getRecent") do
  ...
  def test_favorites_getPublicList
    VCR.use_cassette("favorites.getPublicList") do
  ...
  def test_groups_getInfo
    VCR.use_cassette("groups.getInfo") do
  ...
  def test_groups_search
    VCR.use_cassette("groups.search") do
  ...
  def test_people_findByEmail
    VCR.use_cassette("people.findByEmail") do
  ...
  def test_people_findByUsername
    VCR.use_cassette("people.findByUsername") do
  ...
  def test_people_getInfo
    VCR.use_cassette("people.getInfo") do
  ...
  def test_people_getPublicGroups
    VCR.use_cassette("people.getPublicGroups") do
  ...
  def test_people_getPublicPhotos
    VCR.use_cassette("people.getPublicPhotos") do
  ...
  def test_photos_getInfo
    id = "3839885270"
    VCR.use_cassette("photos.getInfo_#{id}_#{id}") do
  ...
  def test_photos_getExif
    VCR.use_cassette("photos.getExif") do
  ...
  def test_photos_getSizes
    VCR.use_cassette("photos.getSizes") do
  ...
  def test_photos_search
    VCR.use_cassette("photos.search_by_user_id") do
  ...
  def test_photos_comments_getList
    VCR.use_cassette("photos.comments") do
  ...
  def test_tags_getListPhoto
    VCR.use_cassette("tags.getListPhoto") do
  ...
  def test_tags_getListUser
    VCR.use_cassette("tags.getListUser") do
  ...
  def test_urls_getGroup
    VCR.use_cassette("urls.getGroup") do
  ...
  def test_urls_getUserPhotos
    VCR.use_cassette("urls.getUserPhotos") do
  ...
  def test_urls_getUserProfile
    VCR.use_cassette("urls.getUserProfile") do
  ...
  def test_urls_lookupGroup
    VCR.use_cassette("urls.lookupGroup") do
  ...
  def test_urls_lookupUser
    VCR.use_cassette("urls.lookupUser") do
  ...
  def test_urls
    id = "3839885270"
    VCR.use_cassette("photos.getInfo_#{id}") do
      info = @flickr.photos.getInfo(:photo_id => id)
